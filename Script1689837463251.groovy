...
img1 = WebUI.takeScreenshot(img1_path)
...
img2 = WebUI.takeScreenshot(img2_path)

WebUI.delay(5)

CustomKeywords.'test.test.compareImages2'(img1, img2, 'C:/Users/gulsah.seher/Katalon Studio/Compare_Screenshot/screenshots/difference_test1_test2.png')
